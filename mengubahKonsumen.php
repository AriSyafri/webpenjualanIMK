<?php
    ...
    $var = $_GET["idkonsumen"];
    $konsumen = query("SELECT * FROM konsumen WHERE idkonsumen = '$var'")[0];


    if (isset($_POST["submit"])){
        if(mengubahKonsumen($_POST) > 0) {
            echo "
                <script>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Mengubah Konsumen</h1>
                        ...
                        <form action= "" method="POST">
                            ...
                            <input type="hidden" id="idkonsumen" name="idkonsumen" value="<?= $konsumen["idkonsumen"]; ?>">


                            <div class="mb-3">
                                <label for="namaKonsumen" class="form-label">Masukkan Nama Konsumen</label>
                                <input type="text" class="form-control" id="namaKonsumen" name="namaKonsumen" value="<?= $konsumen["namakonsumen"]; ?>">
                            </div>

                            <div class="mb-3">
                                <label for="nohp" class="form-label">Masukkan No HP</label>
                                <input type="text" class="form-control" id="nohp" name="nohp" value="<?= $konsumen["nohp"]; ?>">
                            </div>
