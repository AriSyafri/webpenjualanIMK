                    ...
                    <div class="container-fluid px-4">
                        ...
                        <tbody>
                            ...
                            <td style="text-align: center;">
                                ...
                                <a class="btn btn-secondary" href="mengubahBarang.php?idbarang=<?= $row["idbarang"]; ?>">Ubah</a> 
                                <!-- <a class="btn btn-danger"> Hapus</a> -->
                                <a class="btn btn-danger" href="hapusBarang.php?idbarang=<?= $row["idbarang"]; ?>"onclick="return confirm('yakin?');"> Hapus</a>
                            </td>
                        </tr>
                            <?php endforeach; ?>
                        </tbody>
