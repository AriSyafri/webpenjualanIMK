                    ...
                    <div class="container-fluid px-4">
                        ...
                        <tbody>
                            ...
                            <td style="text-align: center;">
                                ...
                                <a class="btn btn-secondary" href="mengubahPegawai.php?idpegawai=<?= $row["idpegawai"]; ?>">Ubah</a> 
                                <!-- <a class="btn btn-danger"> Hapus</a> -->
                                <a class="btn btn-danger" href="hapusPegawai.php?idpegawai=<?= $row["idpegawai"]; ?>"onclick="return confirm('yakin?');"> Hapus</a>
                            </td>
                        </tr>
                            <?php endforeach; ?>
                        </tbody>
